      ...
      >
        <div className="relative inline-block group">
          ...
          <div className="relative px-6 py-2 rounded-full bg-secondary ring-1 ring-white/10 leading-none flex items-center">
            <span className="text-black dark:text-purple-100 font-medium text-sm">Available for hire</span>
          </div>
        </div>
        ...
        <p className="text-xl md:text-2xl text-black dark:text-purple-100/80 mb-10 max-w-2xl mx-auto leading-relaxed">
